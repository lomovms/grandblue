$(document).ready(function () {
    ...
    $('.js-reset').click(function() {
        ...
        var img = gen.find('.js-gen-img');

        img.each(function() {
            var img = $(this);
            var src = 'img/content/prize2/' + img.attr('data-img');
            ...
            get_total.find('.generator-row').eq(row_num).find('.page-prize-gen__item').eq(num).find('img').attr('src', src);
        });
    });
